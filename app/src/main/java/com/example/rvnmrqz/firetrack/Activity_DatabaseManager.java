...
public class Activity_DatabaseManager extends Activity implements OnItemClickListener {
...
// all global variables
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
		dbm = new DBHelper(Activity_DatabaseManager.this);

		mainscrollview = new ScrollView(Activity_DatabaseManager.this);
		...
		//the main linear layout to which all tables spinners etc will be added.In this activity every element is created dynamically  to avoid using xml file
		 mainLayout = new LinearLayout(Activity_DatabaseManager.this);
		...
		final LinearLayout firstrow = new LinearLayout(Activity_DatabaseManager.this);
		firstrow.setPadding(0,10,0,20);
		LinearLayout.LayoutParams firstrowlp = new LinearLayout.LayoutParams(0, 150);
		firstrowlp.weight = 1;

		TextView maintext = new TextView(Activity_DatabaseManager.this);
		maintext.setText("Select Table");
		maintext.setTextSize(22);
		maintext.setLayoutParams(firstrowlp);
		select_table=new Spinner(Activity_DatabaseManager.this);
		...
		TextView secondrowtext = new TextView(Activity_DatabaseManager.this);
		secondrowtext.setText("No. Of Records : ");
		secondrowtext.setTextSize(20);
		secondrowtext.setLayoutParams(secondrowlp);
		tv =new TextView(Activity_DatabaseManager.this);
		tv.setTextSize(20);
		...
		final Button submitQuery = new Button(Activity_DatabaseManager.this);
		...
		final TextView help = new TextView(Activity_DatabaseManager.this);
		...
		final Spinner spinnertable =new Spinner(Activity_DatabaseManager.this);
		...
		final LinearLayout thirdrow = new LinearLayout(Activity_DatabaseManager.this);
		previous = new Button(Activity_DatabaseManager.this);
		previous.setText("Previous");

		previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
		previous.setLayoutParams(secondrowlp);
		next = new Button(Activity_DatabaseManager.this);
		next.setText("Next");
		...
		tvmessage =new TextView(Activity_DatabaseManager.this);
		...
		final Button customQuery = new Button(Activity_DatabaseManager.this);
       ...
       // a query which returns a cursor with the list of tables in the database.We use this cursor to populate spinner in the first row
		...
		do{
			...
			ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(Activity_DatabaseManager.this,
        ...
        tablenamesadapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		 ...
		 select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			// a array adapter which add values to the spinner which helps in user making changes to the table
	                ArrayAdapter<String> adapter = new ArrayAdapter<String>(Activity_DatabaseManager.this,
	            	    ...
	            	    public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
	                    		...
	                    		runOnUiThread(new Runnable() {
	                    			   ...
	                    			   public void run() {
	                    				if(!isFinishing()){
		                    						        ...
		                    						        new AlertDialog.Builder(Activity_DatabaseManager.this)
	                    	...
	                    	if(spinnertable.getSelectedItem().toString().equals("Add row to this table"))
	                    	{
	                    		...
	                    		final LinkedList<TextView> addnewrownames = new LinkedList<TextView>();
	                        	  ...
	                        	  final ScrollView addrowsv =new ScrollView(Activity_DatabaseManager.this);
	                            ...
	                            final RelativeLayout addnewlayout = new RelativeLayout(Activity_DatabaseManager.this);
	                        	...
	                        	addnewparams.addRule(RelativeLayout.ALIGN_PARENT_TOP);
	                        	    ...
	                        	    et.setId(k);
	                        	    final LinearLayout ll = new LinearLayout(Activity_DatabaseManager.this);
	                ...
	                {
	                 LinearLayout cell = new LinearLayout(Activity_DatabaseManager.this);
	...
	//edit texts which has the values of the row which user has selected
      ...
      final RelativeLayout lp = new RelativeLayout(Activity_DatabaseManager.this);
      lp.setBackgroundColor(Color.WHITE);
  	  RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
  	  lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

  	  final ScrollView updaterowsv =new ScrollView(Activity_DatabaseManager.this);
  	  LinearLayout lcrud = new LinearLayout(Activity_DatabaseManager.this);
  	  ...
  	  //spinner which displays update , delete options
          ...
          ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(Activity_DatabaseManager.this,
